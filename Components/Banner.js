...
const Banner = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start max-sm:p-4 pt-32 max-sm:pt-32">
      <div className="flex flex-col items-center lg:items-start rounded-md p-6 lg:w-1/2 mt-5 mx-24">
        <div className="text-center lg:text-left">
          <h3 className="text-5xl text-gray-700 max-sm:text-3xl">
            ...
            <br /> <span className="text-4xl textColor max-sm:text-3xl">with AI</span>
          </h3>
        </div>
        ...
        <div className="mt-7 text-md text-gray-600 max-sm:text-sm">
          ...
          <h5 className="mb-2"> ✔ Optimize your Portfolio with AI Suggestions.</h5>
          <div className="text-center lg:text-left">
